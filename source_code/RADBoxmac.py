...
try:
    ...
    for devi in ports:
        if "CP210x" in devi.description or "Silicon Labs" in devi.description or "usbserial" in devi.device:
...
try:
    ...
    print(f"It will take roughly {round(sampling_time, 2)} minute(s) to collect the data.")
